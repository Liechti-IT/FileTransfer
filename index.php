...
<div id="upload_finished">
    ...
    <p>
        ...
        <button class="custom_copy_button" id="upload_link_button">copy</button>
    </p>
    </div>
    ...
    <p>
        ...
        <button class="custom_copy_button" id="preview_link_button">copy</button>
    </p>
    </div>
    <?php
} ?>
    ...
    <p>
        ...
        <button class="custom_copy_button" id="direct_link_button">copy</button>
    </p>
    </div>
    ...
    <p>
        ...
        <button class="custom_copy_button" id="delete_link_button">copy</button>
    </p>
    </div>
